...
export default function ThankYouPage() {
  return (
    <Suspense fallback={<div className="space-y-6"><div><h1 className="text-2xl font-bold">Thank-You Page</h1><p className="text-muted-foreground">Loading...</p></div></div>}>
      <ThankYouPageInner />
    </Suspense>
  );
}
...
function ThankYouPageInner() {
  ...
  const { artifact, loading, save, regenerate, generate, refetch } =
    useArtifact(webinarId, "thank_you");
